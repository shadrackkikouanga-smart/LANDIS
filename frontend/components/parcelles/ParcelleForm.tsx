...
export default function ParcelleForm({
  ...
  async function handleSubmit(
    ...
    if (!numero.trim()) {
      setError(
        "Le numéro de parcelle est obligatoire.",
      );
      return;
    }
            ...
            <div>
              ...
              >
                ...
                {blocs.map((bloc) => (
                  ...
                  >
                    {bloc.reference} —{" "}
                    {bloc.superficie.toLocaleString(
                      "fr-FR",
                    )}{" "}
                    m²
                  </option>
